    ...
    <div>
      <Layout>
        ...
        <div className={styles.header}>
          <h1>About</h1>
          <p className={styles.matter}>I am a motivated engineering student with a knack for communication and leadership. I have a good coding base as well as expertise of digital marketing (Facebook). I've always been interested in and active in technology, so I was encouraged to try engineering in Computer Science to expand my interests and keep abreast inside the digital bubble.
          <br />
